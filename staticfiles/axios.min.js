      ...
      if (
        ...
        if (De.hasStandardBrowserEnv || De.hasStandardBrowserWebWorkerEnv)
          ...
          var f = t
            ...
            p = l.slice(1);
          s.setContentType(
            [h || 'multipart/form-data'].concat(g(p)).join('; '),
          );
        }
      if (
          ...
          i = function (e) {
            if (!n) {
              ...
              o.abort(
                t instanceof me
                  ? t
                  : new Ye(t instanceof Error ? t.message : t),
              );
            }
          },
          a =
              ...
              for (;;)
                switch ((e.prev = e.next)) {
                  ...
                  case 6:
                    ...
                    return (
                      (h = l.value), e.delegateYield(r(n(dt(h, o))), 't0', 9)
                    );
                  case 9:
                    (a = !1), (e.next = 4);
                    break;
                  ...
                  function (t) {
                    for (;;)
                      switch ((t.prev = t.next)) {
                        ...
                        case 15:
                          throw (
                            ((t.prev = 15), (t.t0 = t.catch(0)), u(t.t0), t.t0)
                          );
                        case 19:
                        case 'end':
                          return t.stop();
  ...
  var jt = function (e) {
    ...
    Lt = function (e) {
      for (
        ...
        if (
          ((r = t = e[i]),
          !Pt(t) && void 0 === (r = At[(a = String(t)).toLowerCase()]))
        )
